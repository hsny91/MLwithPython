...
data = pd.read_csv("/Users/hsekeroglu/Desktop/Huesniye/MLwithPython/Classification/Logistic_regression/data.csv")
...
def forward_backward_propagation(w,b,x_train,y_train):
    ...
    z = np.dot(w.T,x_train) + b
    y_head = sigmoid(z)
    loss = -y_train*np.log(y_head)-(1-y_train)*np.log(1-y_head) # -(1-y)log(1-y_head)-ylog(y_head)
